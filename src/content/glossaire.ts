...
const fr: GlossaireContent = {
  ...
  terms: [
    ...
    { sigle: "Escrow (OHADA)", intitule: "Compte séquestre de droit OHADA", def: "Compte bloqué où les fonds sont sanctuarisés ; les décaissements sont conditionnés au visa technique attestant des jalons atteints." },
    ...
    { sigle: "OHADA", intitule: "Organisation pour l'Harmonisation en Afrique du Droit des Affaires", def: "Cadre juridique commun à 17 États africains, base du compte séquestre (escrow) et de la comptabilité SYSCOHADA." },
...
const en: GlossaireContent = {
  ...
  terms: [
    ...
    { sigle: "Escrow (OHADA)", intitule: "OHADA-law escrow account", def: "A blocked account ring-fencing funds; disbursements are conditioned on the technical sign-off attesting to milestones reached." },
    ...
    { sigle: "OHADA", intitule: "Organisation for the Harmonisation of Business Law in Africa", def: "Common legal framework across 17 African states, basis for the escrow account and SYSCOHADA accounting." },
