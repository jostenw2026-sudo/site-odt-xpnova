...
export const metadata: Metadata = {
  ...
  description:
    "ODT territorial mapping: the 12 structuring development domains (SND30), the 7 families of actors, convergence engineering (OHADA escrow, technical sign-off) and the contractual path.",
